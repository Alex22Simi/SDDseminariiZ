...
void afisareListaMasini(/*lista de masini N* nod) {
...
void adaugaMasinaInLista(/*lista de masiniN** lista, Masina masinaNoua) {
...
void dezalocareListaMasini(/*lista de masini N** lista) {
...
float calculeazaPretMediu(/*lista de masini N* lista) {
...
float calculeazaPretulMasinilorUnuiSofer(/*lista masini N* lista, const char* numeSofer) {
...
int main() {
	...
	printf("\n");
	float medie = calculeazaPretMediu(nod);
	printf("Media este: %2.f", medie);
	float sumaSofer = calculeazaPretulMasinilorUnuiSofer(nod, "Ionescu");
	printf("\n Suma soferului este: %.2f", sumaSofer);
	int nrUsi = getNrUsiMasinaScumpa(nod);
	printf("\n");
	printf("Numarul de usi ale celei mai scumpe masini este : %i", nrUsi);
